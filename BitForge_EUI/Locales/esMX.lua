...
L["cmd:helpListUnmanaged"] = "  -u -- solo los elementos que el diseño guardado no administra"
L["cmd:helpReset"] = "reset [anchors] -- descartar el diseño guardado"
L["cmd:deprecated"] = "/bfeui quedó obsoleto -- usa /bitforge eui en su lugar"
...
L["reason:norect"] = "el objetivo todavía no tiene posición en pantalla"
L["reason:notextended"] = "no hay point ni relPoint que resolver"

L["list:none"] = "No hay elementos coincidentes"
L["list:count"] = "%d mostrados, %d/%d sin administrar"
L["list:unmanaged"] = "[sin administrar]"
L["list:anchored"] = "[anclaje -> %s %s]"
L["list:noPosition"] = "sin posición"
L["list:readFailed"] = "%s (falló la lectura)"
...
L["anchor:collides"] = "el anclaje '%s' choca con un elemento existente de EllesmereUI (%s); cámbiale el nombre"

L["ui:title"] = "Diseño de BitForge"
L["ui:filter"] = "Buscar"
L["ui:notReady"] = "Todavía se está leyendo tu diseño -- inténtalo de nuevo en un momento"
...
L["ui:invalid"] = "%d problema(s) por corregir antes de guardar"
...
L["report:blurb"] = "Este reporte incluye la etiqueta y la carpeta de un elemento de EllesmereUI, si está anclado a otro elemento y por qué lado, su posición y tamaño guardados, y si el diseño guardado lo administra. Nada aquí menciona tu personaje, reino, hermandad o facción."
