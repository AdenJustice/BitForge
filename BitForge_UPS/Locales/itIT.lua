...
L["settings:enabledTooltip"] = "Deposita i materiali d'artigianato nella Banca della Brigata quando visiti una banca"
...
L["msg:noVacancy"] = "UPS: La Banca della Brigata è piena."
