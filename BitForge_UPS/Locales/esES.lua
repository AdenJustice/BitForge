...
L["settings:enabledTooltip"] = "Depositar materiales de artesanía en el Banco de la banda guerrera al visitar un banco"
...
L["msg:noVacancy"] = "UPS: El Banco de la banda guerrera está lleno."
