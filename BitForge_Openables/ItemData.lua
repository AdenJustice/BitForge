...
enum.ALLOW_LIST = {
    ...
    [111364] = PRIORITY.OPEN,  -- First Aid in Draenor
    ...
    [139591] = PRIORITY.LEARN, -- Stolen Tome of Artifact Lore
    ...
    [205423] = PRIORITY.OPEN,  -- Shadowflame Residue Sack
    ...
    [210324] = PRIORITY.TOKEN, -- Cracked Medal of Honor
    ...
    [235531] = PRIORITY.OPEN,  -- Restored Coffer Key
}
