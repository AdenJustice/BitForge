...
---@class BitForge.Dispatch.Locale
local L = ns.locale
...
L["msg:replacedInstalled"] = "Dispatch: Still installed — %s."
L["msg:replacedInstalledFix"] = "Delete the old installation, then log in again to let Dispatch take over."
...
-- /bfdump dispatch open all's own footnote: it discloses every ranked
...
-- /bfdump dispatch allowlist's own footnote. It reads the shipped list and
...
-- Messages
L["msg:nothingToDo"] = "Dispatch: Nothing to move."
L["msg:done"] = "Dispatch: Done. Moved %d item(s)."
L["msg:noVacancy"] = "Dispatch: The Warband Bank is full."
L["msg:blockedCombat"] = "Dispatch: Stopped — you are in combat."
L["msg:blockedBankClosed"] = "Dispatch: Stopped — the bank closed."
L["msg:blockedCursor"] = "Dispatch: Stopped — something is on your cursor."
L["msg:blockedLocked"] = "Dispatch: Stopped — an item is locked."
L["msg:moveFailed"] = "Dispatch: Stopped — a move did not complete."
L["msg:openProfession"] = "Dispatch: Open your %s window once so Dispatch can record which recipes you know."
...
L["msg:noVacancyPrivate"] = "Dispatch: Your bank is full."
...
"In combat and inside instances the game sometimes withholds an item's details. Dispatch keeps those items rather than guessing, so a few may be missing from the list -- that is expected. A verdict that looks wrong for any other reason is worth reporting."
...
L["rule:junkBlurb"] =
"Grey items, whatever kind of item they are. Off by default, because another addon usually handles this. If nothing else does, turn it on and Dispatch will clear them for you."
L["rule:epic"] = "Legendary And Above"
L["rule:epicSub"] = "Legendary, Artifact, Heirloom"
L["rule:epicBlurb"] =
"Never sold. The vendor shows a price for these and then refuses the sale, so Dispatch does not put them on the list."
...
L["rule:bagsBlurb"] =
"Never sold. Which bags you carry is your call, so Dispatch does not judge them."
...
L["rule:noneBlurb"] =
"Item types Dispatch does not judge at all: quest items, keys, caged pets, glyphs, WoW Tokens, spell reagents, arrows and the other retired categories. They stay in your bags no matter how the rules above are set."
