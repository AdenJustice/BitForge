...
L["msg:replacedInstalled"] = "Dispatch : Toujours installé — %s."
L["msg:replacedInstalledFix"] = "Supprimez l'ancienne installation, puis reconnectez-vous pour laisser Dispatch prendre le relais."
...
L["report:blurbField"] = "Ce rapport contient chaque candidat que le dernier scan a classé pour la prochaine ouverture, dans l'ordre du classement : le nom, l'ID de l'objet, le sac et l'emplacement, la quantité empilée, la priorité et la raison de son classement, s'il s'agit d'un coffre verrouillé nécessitant une clé, si son emplacement est actuellement verrouillé, et s'il est en recharge ou différé. Rien ici ne mentionne votre personnage, royaume, guilde ou faction, et le texte de l'infobulle d'aucun objet n'est inclus."

L["report:blurbAllowList"] = "Ce rapport contient chaque objet des deux listes d'ouverture tenues à la main par l'addon : la liste d'autorisation et la liste de refus, une section pour chacune, ou une seule lorsque vous nommez une liste. Chaque ligne donne l'ID de l'objet et son nom, le verdict auquel arrivent les règles d'ouverture lorsque cette liste est ignorée, l'échelon qui l'a rendu, la priorité que cet échelon a accordée et, pour la seule liste d'autorisation, celle qu'elle fixe à l'objet, ainsi que le groupe dans lequel l'entrée tombe. Lorsqu'une ligne indique plutôt que les données de l'objet ou son infobulle ne sont jamais revenues, cela décrit le cache de ce client au moment où vous avez lancé la commande, et non l'objet lui-même ; au premier lancement, c'est le cas de la plus grande partie de la liste d'autorisation. Il lit les listes fournies et l'infobulle de chaque objet par son ID, il ne décrit donc rien de vos sacs -- sauf qu'un objet des listes que vous avez exclu ou ignoré durant cette session est signalé comme tel, tout comme un verdict qui a dépendu de l'état de ce personnage, par exemple si vous pouvez utiliser l'objet ou ouvrir un coffre verrouillé. Rien ici ne nomme votre personnage, votre royaume, votre guilde ou votre faction."
...
L["msg:nothingToDo"] = "Dispatch : Rien à déplacer."
L["msg:done"] = "Dispatch : Terminé. %d objet(s) déplacé(s)."
L["msg:noVacancy"] = "Dispatch : La banque de bataillon est pleine."
L["msg:blockedCombat"] = "Dispatch : Arrêté — vous êtes en combat."
L["msg:blockedBankClosed"] = "Dispatch : Arrêté — la banque s'est fermée."
L["msg:blockedCursor"] = "Dispatch : Arrêté — vous tenez quelque chose au curseur."
L["msg:blockedLocked"] = "Dispatch : Arrêté — un objet est verrouillé."
L["msg:moveFailed"] = "Dispatch : Arrêté — un déplacement n'a pas abouti."
L["msg:openProfession"] = "Dispatch : Ouvrez une fois votre fenêtre %s pour que Dispatch puisse enregistrer les recettes que vous connaissez."
...
L["msg:noVacancyPrivate"] = "Dispatch : Votre banque est pleine."
...
"En combat et dans les instances, le jeu refuse parfois de révéler les détails d'un objet. Dispatch garde ces objets plutôt que de deviner, donc il se peut que quelques-uns manquent à la liste -- c'est normal. Un verdict qui semble erroné pour toute autre raison mérite d'être signalé."
...
L["rule:junkBlurb"] =
"Les objets gris, quel que soit leur type. Désactivé par défaut, car un autre addon s'en charge généralement. Si aucun ne le fait, activez cette option et Dispatch les videra pour vous."
L["rule:epic"] = "Légendaire et au-delà"
L["rule:epicSub"] = "Légendaire, Artefact, Objet de famille"
L["rule:epicBlurb"] =
"Jamais vendu. Le marchand affiche un prix pour ces objets puis refuse la vente, donc Dispatch ne les met pas sur la liste."
...
L["rule:bagsBlurb"] =
"Jamais vendus. Quels sacs vous portez, c'est votre choix, donc Dispatch ne les juge pas."
...
L["rule:noneBlurb"] =
"Types d'objets que Dispatch ne juge pas du tout : objets de quête, clés, mascottes en cage, glyphes, jetons WoW, composants de sort, flèches et les autres catégories retirées. Ils restent dans vos sacs, quel que soit le réglage des règles ci-dessus."
...
L["report:blurbDisenchant"] = "Ce rapport contient l'état actuel de ciblage de sort du client et si ce personnage peut désenchanter. Il contient aussi jusqu'à huit armes ou pièces d'armure de vos sacs qui pourraient valoir la peine d'être désenchantées, chacune avec son sac, son emplacement, son ID d'objet, son nom, sa qualité, son type d'objet et la propre prédiction de BitForge quant à la possibilité de le désenchanter, ainsi que le texte complet de son infobulle. Pour tout autre objet de vos sacs dont la qualité n'a pas pu être lue, il contient aussi son sac, son emplacement, son ID d'objet et son nom. Rien ici ne nomme votre personnage, votre royaume, votre guilde ou votre faction."
L["report:blurbDispatch"] = "Ce rapport contient le lien et la qualité de l'objet, le sac et l'emplacement d'où il a répondu quand vous le portez sur vous, le verdict auquel chaque voie de règles est parvenue pour lui -- son propre détail supplémentaire, et s'il provient d'une dérogation enregistrée -- ainsi que la revendication, la force et la raison propres à chaque voie, y compris toute voie qui n'aurait pas pu répondre du tout. Quand l'objet est de qualité médiocre, ce rapport indique aussi si la fonction « Vendre les déchets » de Blizzard le vendrait quand même, selon vos propres réglages de vente et de la règle des déchets. Quand l'objet est un composant d'artisanat, ce rapport contient aussi les métiers pour lesquels le catalogue fourni le répertorie, les métiers enregistrés pour ce compte -- ou ceux de ce personnage seul, quand l'exemplaire est lié à l'âme -- l'extension à laquelle l'objet appartient et si vous avez coché cette extension, si une recette que vous avez marquée en a besoin, et avec lequel de ces éléments la règle des composants a elle-même répondu -- son propre verdict, qui n'est pas toujours ce qui a décidé du sort de l'objet. Il liste toujours les recettes que vous avez marquées, par identifiant et, là où le jeu peut encore en nommer une, par nom : il indique donc ce que vous fabriquez, et pas seulement ce que vous portez sur vous. Quand le diagnostic est activé, ce rapport contient aussi la carte sur laquelle vous vous trouviez et la carte qui la contient et, pour un objet restreint à un lieu, les lieux que cette restriction nomme et lequel d'entre eux correspondait à l'endroit où vous étiez. Un lien d'objet indique le niveau et la spécialisation de votre personnage -- cela fait partie du format du lien lui-même, et le retirer ferait perdre le détail qui rend le rapport reproductible. Rien ici ne nomme votre personnage, votre royaume, votre guilde ou votre faction."
