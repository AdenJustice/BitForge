...
L["msg:replacedInstalled"] = "Dispatch: Noch installiert — %s."
L["msg:replacedInstalledFix"] = "Löscht die alte Installation und meldet Euch erneut an, damit Dispatch übernehmen kann."
...
L["report:blurbField"] = "Dieser Bericht enthält jeden Kandidaten, den der letzte Scan zum nächsten Öffnen eingestuft hat, in der eingestuften Reihenfolge: jeweils Name, Gegenstands-ID, Tasche und Platz, Stapelanzahl, Priorität und den Grund für die Einstufung, ob er eine verschlossene Kiste ist, die einen Schlüssel braucht, ob sein Platz gerade gesperrt ist, und ob er sich in der Abklingzeit befindet oder aufgeschoben wurde. Nichts hier nennt Euren Charakter, Euren Realm, Eure Gilde oder Eure Fraktion, und der Tooltip-Text keines Gegenstands wird aufgeführt."

L["report:blurbAllowList"] = "Dieser Bericht enthält jeden Gegenstand aus den beiden von Hand gepflegten Öffnen-Listen des Addons -- der Öffnen-Positivliste und der Öffnen-Negativliste, je ein Abschnitt, oder nur einer, wenn Ihr eine Liste benennt. Jede Zeile nennt Gegenstands-ID und Name, das Urteil, zu dem die Öffnen-Regeln ohne die jeweilige Liste kommen, die Stufe, die es gefällt hat, die Priorität, die diese Stufe vergeben hat, und -- allein bei der Positivliste -- die Priorität, auf die sie den Gegenstand festlegt, sowie die Gruppe, in die der Eintrag fällt. Sagt eine Zeile stattdessen, dass die Daten des Gegenstands oder sein Tooltip nie zurückkamen, beschreibt das den Zwischenspeicher dieses Clients in dem Moment, in dem Ihr den Befehl ausgeführt habt, und nichts über den Gegenstand selbst; beim ersten Aufruf trifft das auf den größten Teil der Positivliste zu. Er liest die mitgelieferten Listen und den Tooltip jedes Gegenstands über dessen ID, beschreibt also nichts in Euren Taschen -- außer dass ein gelisteter Gegenstand, den Ihr ausgeschlossen oder für diese Sitzung übersprungen habt, als solcher genannt wird, ebenso wie ein Urteil, das vom Zustand dieses Charakters abhing, etwa ob Ihr den Gegenstand benutzen oder eine verschlossene Kiste öffnen könnt. Nichts hier nennt Euren Charakter, Euren Realm, Eure Gilde oder Eure Fraktion."
...
L["msg:nothingToDo"] = "Dispatch: Nichts zu verschieben."
L["msg:done"] = "Dispatch: Fertig. %d Gegenstand/Gegenstände verschoben."
L["msg:noVacancy"] = "Dispatch: Die Kriegsmeutenbank ist voll."
L["msg:blockedCombat"] = "Dispatch: Abgebrochen — Ihr seid im Kampf."
L["msg:blockedBankClosed"] = "Dispatch: Abgebrochen — die Bank wurde geschlossen."
L["msg:blockedCursor"] = "Dispatch: Abgebrochen — Ihr haltet etwas am Cursor."
L["msg:blockedLocked"] = "Dispatch: Abgebrochen — ein Gegenstand ist gesperrt."
L["msg:moveFailed"] = "Dispatch: Abgebrochen — eine Bewegung wurde nicht abgeschlossen."
L["msg:openProfession"] = "Dispatch: Öffnet einmal Euer %s-Fenster, damit Dispatch erfassen kann, welche Rezepte Ihr kennt."
...
L["msg:noVacancyPrivate"] = "Dispatch: Eure Bank ist voll."
...
"Im Kampf und in Instanzen verweigert das Spiel manchmal die Details eines Gegenstands. Dispatch behält solche Gegenstände, statt zu raten, daher können ein paar in der Liste fehlen -- das ist normal. Ein Urteil, das aus einem anderen Grund falsch aussieht, ist es wert, gemeldet zu werden."
...
L["rule:junkBlurb"] =
"Graue Gegenstände, unabhängig davon, um welche Art von Gegenstand es sich handelt. Standardmäßig aus, weil das meist schon ein anderes Addon übernimmt. Wenn nichts anderes es tut, schaltet es ein, und Dispatch räumt sie für Euch weg."
L["rule:epic"] = "Legendär und höher"
L["rule:epicSub"] = "Legendär, Artefakt, Erbstück"
L["rule:epicBlurb"] =
"Wird nie verkauft. Der Händler zeigt für diese einen Preis an und lehnt den Verkauf dann trotzdem ab, weshalb Dispatch sie gar nicht erst auf die Liste setzt."
...
L["rule:bagsBlurb"] =
"Werden nie verkauft. Welche Taschen Ihr tragt, ist Eure Entscheidung, deshalb beurteilt Dispatch sie nicht."
...
L["rule:noneBlurb"] =
"Gegenstandsarten, die Dispatch überhaupt nicht beurteilt: Questgegenstände, Schlüssel, eingesperrte Haustiere, Glyphen, WoW-Marken, Zauberreagenzien, Pfeile und die anderen ausrangierten Kategorien. Sie bleiben in Euren Taschen, egal wie die Regeln oben eingestellt sind."
...
L["report:blurbDisenchant"] = "Dieser Bericht enthält den aktuellen Zielerfassungsstatus des Clients und ob dieser Charakter entzaubern kann. Außerdem enthält er bis zu acht Waffen oder Rüstungsteile aus Euren Taschen, die sich zum Entzaubern lohnen könnten, jeweils mit Tasche, Platz, Gegenstands-ID, Name, Qualität, Gegenstandstyp und BitForges eigener Einschätzung, ob er sich entzaubern lässt, dazu dem vollständigen Text seines Tooltips. Für jeden anderen Gegenstand in Euren Taschen, dessen Qualität nicht gelesen werden konnte, enthält er ebenfalls dessen Tasche, Platz, Gegenstands-ID und Namen. Nichts hier nennt Euren Charakter, Euren Realm, Eure Gilde oder Eure Fraktion."
L["report:blurbDispatch"] = "Dieser Bericht enthält den Link und die Qualität des Gegenstands, aus welcher Tasche und welchem Platz er stammt, wenn Ihr ihn bei Euch tragt, die Entscheidung, zu der jeder Regelpfad für ihn kam -- ihr eigenes zusätzliches Detail und ob sie aus einer gespeicherten Überschreibung stammt -- sowie den jeweiligen Anspruch, die Stärke und den Grund jedes Pfads, einschließlich eines etwaigen Pfads, der überhaupt nicht antworten konnte. Ist der Gegenstand von schlechter Qualität, gibt der Bericht zudem an, ob Blizzards eigene Funktion „Schrott verkaufen“ ihn trotzdem verkauft, je nachdem, wie Euer Verkauf und die Schrott-Regel eingestellt sind. Ist der Gegenstand eine Handwerksreagenz, enthält der Bericht außerdem die Berufe, für die der mitgelieferte Katalog sie führt, die für dieses Konto verzeichneten Berufe -- oder nur die dieses Charakters, wenn das Exemplar seelengebunden ist -- die Erweiterung, zu der der Gegenstand gehört, und ob Ihr diese Erweiterung angehakt habt, ob ein von Euch markiertes Rezept sie braucht, und womit davon die Regel für Reagenzien selbst geantwortet hat -- ihre eigene Entscheidung, die nicht immer die ist, die über den Gegenstand entschieden hat. Er listet immer die von Euch markierten Rezepte auf, mit ihrer ID und, wo das Spiel eines noch benennen kann, mit ihrem Namen, er sagt also, was Ihr herstellt, und nicht nur, was Ihr bei Euch tragt. Ist die Diagnose eingeschaltet, enthält der Bericht außerdem die Karte, auf der Ihr gestanden habt, und die Karte, die sie enthält -- und bei einem Gegenstand, der auf einen Ort beschränkt ist, die Orte, die diese Beschränkung nennt, und welcher davon zu Eurem Standort gepasst hat. Ein Gegenstandslink verrät die Stufe und Spezialisierung Eures Charakters -- das ist Teil des Formats des Links selbst, und ihn zu entfernen würde die Details verlieren, die den Bericht nachvollziehbar machen. Nichts hier nennt Euren Charakter, Euren Realm, Eure Gilde oder Eure Fraktion."
