...
L["msg:nothingToDo"] = "Dispatch: No hay nada que mover."
L["msg:done"] = "Dispatch: Listo. Se movieron %d objeto(s)."
L["msg:noVacancy"] = "Dispatch: El Banco de tropa está lleno."
L["msg:blockedCombat"] = "Dispatch: Detenido — estás en combate."
L["msg:blockedBankClosed"] = "Dispatch: Detenido — se cerró el banco."
L["msg:blockedCursor"] = "Dispatch: Detenido — traes algo en el cursor."
...
"En combate y dentro de instancias, el juego a veces no revela los detalles de un objeto. Dispatch conserva esos objetos en lugar de suponer, así que es posible que falten algunos en la lista -- eso es normal. Un veredicto que se vea incorrecto por cualquier otro motivo vale la pena reportarlo."
...
L["rule:bagsBlurb"] =
"Nunca se venden. Qué bolsas llevas es decisión tuya, así que Dispatch no las evalúa."
...
L["rule:noneBlurb"] =
"Tipos de objeto que Dispatch no evalúa en absoluto: objetos de misión, llaves, mascotas enjauladas, glifos, vales de WoW, componentes de hechizos, flechas y las demás categorías retiradas. Se quedan en tus bolsas sin importar cómo estén configuradas las reglas de arriba."
...
L["report:blurbDisenchant"] = "Este reporte incluye el estado actual de selección de objetivo del cliente y si este personaje puede desencantar. También incluye hasta ocho armas o piezas de armadura de tus bolsas que podrían valer la pena desencantar, cada una con su bolsa, ranura, ID de objeto, nombre, calidad, tipo de objeto y la propia predicción de BitForge sobre si se puede desencantar, además del texto completo de su tooltip. Para cualquier otro objeto de tus bolsas cuya calidad no se pudo leer, también incluye su bolsa, ranura, ID de objeto y nombre. Nada aquí nombra a tu personaje, tu reino, tu hermandad o tu facción."
L["report:blurbDispatch"] = "Este reporte incluye el vínculo y la calidad del objeto, de qué bolsa y ranura respondió cuando lo traes contigo, el veredicto al que llegó cada vía de reglas para él -- su propio detalle adicional, y si vino de una anulación guardada -- y la reclamación, la fuerza y el motivo propios de cada vía, incluida cualquier vía que no pudiera responder en absoluto. Cuando el objeto es de calidad pobre, el reporte también indica si la función «Vender chatarra» de Blizzard lo vendería de todos modos, según tus propios ajustes de venta y de la regla de chatarra. Cuando el objeto es un componente de artesanía, el reporte también incluye las profesiones para las que lo lista el catálogo que viene con el complemento, las profesiones registradas para esta cuenta -- o nada más las de este personaje, cuando el objeto está vinculado al alma -- la expansión a la que pertenece el objeto y si tienes esa expansión seleccionada, si una receta que hayas marcado lo necesita, y con cuál de todo eso respondió la propia regla de componentes -- su propio veredicto, que no siempre es lo que decidió el objeto. Siempre enumera las recetas que has marcado, por ID y, donde el juego todavía puede nombrar alguna, por nombre, así que dice lo que fabricas y no nada más lo que traes contigo. Cuando el diagnóstico está activado, el reporte también incluye el mapa en el que estabas parado y el mapa que lo contiene y, para un objeto restringido a un lugar, los lugares que esa restricción nombra y cuál de ellos correspondía a donde estabas. Un vínculo de objeto indica el nivel y la especialización de tu personaje -- eso es parte del propio formato del vínculo, y eliminarlo perdería el detalle que hace reproducible el reporte. Nada aquí nombra a tu personaje, tu reino, tu hermandad o tu facción."
