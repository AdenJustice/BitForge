...
local DB_DEFAULTS = {
    global = {
        ...
        -- tests/test_dispatch_overrides.lua drives the real prune and the
        ...
        -- tests/test_dispatch_sparedrecipes.lua drives the real prune and the
...
---@field arbiter BitForge.Dispatch.Model.Arbiter
---@field facts BitForge.Dispatch.Model.Facts
---@field openRules BitForge.Dispatch.Model.OpenRules
---@field zone BitForge.Dispatch.Model.Zone
---@field bankRules BitForge.Dispatch.Model.BankRules
---@field rules BitForge.Dispatch.Model.Rules
---@field overrides BitForge.Dispatch.Model.Overrides
---@field sparedRecipes BitForge.Dispatch.Model.SparedRecipes
---@field allowAudit BitForge.Dispatch.Model.AllowAudit
-- Nilable: a release build ships no debug/lines.lua at all.
---@field debugNotices BitForge.Dispatch.Model.DebugNotices|nil
...
function model.Decide(facts, settings)
    ...
    if reagents and reagents.keep and facts.reagentProfessions then
        ...
        local selected =
            ...
            or model.sparedRecipes.WantsReagent(facts.itemID)
