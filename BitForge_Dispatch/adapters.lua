...
---@class BitForge.Dispatch.Control.Adapters
local adapters = {}
...
---@param adapter Dispatch.Adapter
...
---@return table  array of Dispatch.Adapter
...
---@param sources table       array of Dispatch.Adapter, priority-ordered
---@param fallback Dispatch.Adapter
...
--- Shapes verified against ~/Developer/Syndicator -- an occupied slot is
--- { itemID, itemCount, ... } and an empty one is a bare table
--- (Tracking/BagCache.lua:367-386).
---@type Dispatch.Adapter
...
---
--- Verified against ~/Developer/datastore_containers (thaoky, the author) and
--- ~/Developer/DataStore.
---@type Dispatch.Adapter
...
--- behind it. Verified against ~/Developer/BagSync -- IterateUnits yields
...
--- integration point. Verified against ~/Developer/BagBrother --
