...
-- comment states why that invariant holds). BitForge_Dispatch.toc wraps this
...
---@class BitForge.Dispatch.View.DebugLines
local debugLines = {}
...
---@class BitForge.Dispatch.Control.DebugNotices
...
---@class BitForge.Dispatch.Model.DebugNotices
local modelNotices = {}
