...
---@class BitForge.Dispatch.View.RuleControls
local ruleControls = {}
...
--- (BitForge/APIs/UI/Templates/Buttons.lua); a slider or a dropdown is
--- explained by the region this file drew over its label, which is never
--- disabled at all.
---
