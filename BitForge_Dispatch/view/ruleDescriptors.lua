...
---@class BitForge.Dispatch.Enum
local enum = ns.enum

-- Eight subclasses carry a stored key. Generated rather than typed, so a
-- subclass gaining or losing a column in DB_DEFAULTS surfaces as a test
...
-- option:<key>, so twenty-four settings: labels would be twenty-four strings
-- nobody reads.

local CONSUMABLE_SUBCLASSES = { 0, 1, 2, 3, 5, 7, 8, 9 }
local CONSUMABLE_COLUMNS = { "expansions", "recipesNow", "recipesOld" }
...
---@class BitForge.Dispatch.View.RuleDescriptors
local ruleDescriptors = {
    ...
    { key = "reagent", group = "cross", controls = {
        ...
        { section = "reagents", key = "expansions", kind = "expansions",
          name = "reagentsExpansions" },
    } },
    ...
    { key = "gear",        group = "class", controls = {
        ...
        { section = "gear", key = "keepForDisenchant",  kind = "expansions",
          name = "keepForDisenchant" },
        { section = "gear", key = "spareBindOnAccount", kind = "expansions",
          name = "spareBindOnAccount" },
        { section = "gear", key = "spareBindOnEquip",   kind = "expansions",
          name = "spareBindOnEquip" },
    ...
    { key = "gems", group = "class", controls = {
        { section = "gems", key = "expansions", kind = "expansions", name = "gemsExpansions" },
    ...
    { key = "enhancements", group = "class", controls = {
        { section = "enhancements", key = "expansions", kind = "expansions",
          name = "enhancementsExpansions" },
    } },
