...
---@class BitForge.Dispatch.View.SettingsPanel
local settingsPanel = {}

StaticPopupDialogs["BITFORGE_DISPATCH_CONFIRM_RESET_LIST"] = {
...
function settingsPanel.Init()
    ...
    local function AddResetInitializer(labelKey, scope, status)
        local function OnClick()
            StaticPopup_Show("BITFORGE_DISPATCH_CONFIRM_RESET_LIST", nil, nil, {
