...
-- which tests/test_dispatch_zone.lua holds to by matching text -- so naming
...
-- tests/test_dispatch_zone.lua walks this table and refuses the pair.
--
...
-- depended on it.
--
-- Two assertions in tests/test_dispatch_zone.lua state that emptiness, so the
