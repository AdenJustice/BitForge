...
---@class BitForge.Dispatch.Control.OpenScanner
local openScanner = {}
...
function openScanner.Scan()
    ...
    -- ranked-field dump (/bfdump dispatch open all) never captures a locked
    -- row -- the single-item report (/bfdump dispatch open <id>) reads the
