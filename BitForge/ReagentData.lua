-- Auto-generated by Scripts/scrape_reagents.py. Do not edit by hand.
--
-- Which professions want an item as a crafting reagent, one bit each.
--
-- Scraped from Wowhead's profession spell lists, which carry the recipe's
-- skill line and its reagents in the same response. The client's own
-- attribution is not used: it fails outright on some recipes and credits
-- fewer professions than use a reagent on others.
--
-- 2200 reagents across 14 professions, scraped 2026-08-22.
...
-- The interface this data was built against. The runtime compares it with
-- the live client and, in debug, reports that a patch has moved past it:
-- recipes added since are missing until a profession window is opened.
