...
L["msg:replacedInstalled"] = "AzerothPrime: %s disattivato — sostituito da questo addon."
L["msg:replacedInstalledFix"] = "Elimina la vecchia cartella di installazione per non vedere più questo messaggio."
...
L["msg:nothingToDo"] = "AzerothPrime: Niente da spostare."
L["msg:done"] = "AzerothPrime: Fatto. %d oggetto/i spostato/i."
L["msg:noVacancy"] = "AzerothPrime: La Banca della Brigata è piena."
L["msg:blockedCombat"] = "AzerothPrime: Interrotto — sei in combattimento."
L["msg:blockedBankClosed"] = "AzerothPrime: Interrotto — la banca si è chiusa."
L["msg:blockedCursor"] = "AzerothPrime: Interrotto — hai qualcosa sul cursore."
L["msg:blockedLocked"] = "AzerothPrime: Interrotto — un oggetto è bloccato."
L["msg:moveFailed"] = "AzerothPrime: Interrotto — uno spostamento non è riuscito."
L["msg:openProfession"] = "AzerothPrime: Apri una volta la finestra %s così AzerothPrime può registrare quali ricette conosci."
...
L["msg:noVacancyPrivate"] = "AzerothPrime: La tua banca è piena."
...
"In combattimento e nelle istanze, il gioco a volte non rivela i dettagli di un oggetto. AzerothPrime tiene questi oggetti invece di indovinare, quindi alcuni potrebbero mancare dalla lista -- questo è previsto. Un verdetto che sembra sbagliato per qualsiasi altro motivo vale la pena segnalarlo."
...
L["rule:junkBlurb"] =
"Oggetti grigi, qualunque sia il loro tipo. Disattivato per impostazione predefinita, perché di solito se ne occupa un altro addon. Se nessun altro lo fa, attivalo e AzerothPrime li eliminerà per te."
L["rule:epic"] = "Leggendario e superiore"
L["rule:epicSub"] = "Leggendario, Manufatto, Cimelio"
L["rule:epicBlurb"] =
"Non viene mai venduto. Il venditore mostra un prezzo per questi oggetti e poi rifiuta la vendita, quindi AzerothPrime non li mette in lista."
...
L["rule:bagsBlurb"] =
"Non vengono mai vendute. Quali borse porti è una tua scelta, quindi AzerothPrime non le valuta."
...
L["rule:noneBlurb"] =
"Tipi di oggetto che AzerothPrime non valuta affatto: oggetti missione, chiavi, mascotte in gabbia, glifi, gettoni WoW, componenti di incantesimo, frecce e le altre categorie dismesse. Restano nelle tue borse indipendentemente da come sono impostate le regole sopra."
