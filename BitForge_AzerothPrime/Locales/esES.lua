...
L["msg:nothingToDo"] = "AzerothPrime: Nada que mover."
L["msg:done"] = "AzerothPrime: Hecho. %d objeto(s) movido(s)."
L["msg:noVacancy"] = "AzerothPrime: El Banco de la banda guerrera está lleno."
L["msg:blockedCombat"] = "AzerothPrime: Detenido — estás en combate."
L["msg:blockedBankClosed"] = "AzerothPrime: Detenido — el banco se ha cerrado."
L["msg:blockedCursor"] = "AzerothPrime: Detenido — llevas algo en el cursor."
...
"En combate y dentro de instancias, el juego a veces no revela los detalles de un objeto. AzerothPrime conserva esos objetos en lugar de suponer, así que puede que falten algunos en la lista -- eso es normal. Un veredicto que parezca incorrecto por cualquier otro motivo merece la pena reportarlo."
...
L["rule:bagsBlurb"] =
"Nunca se venden. Qué bolsas llevas es decisión tuya, así que AzerothPrime no las juzga."
...
L["rule:noneBlurb"] =
"Tipos de objeto que AzerothPrime no juzga en absoluto: objetos de misión, llaves, mascotas enjauladas, glifos, vales de WoW, componentes de hechizos, flechas y las demás categorías retiradas. Se quedan en tus bolsas sin importar cómo estén configuradas las reglas de arriba."
