...
L["msg:replacedInstalled"] = "AzerothPrime：已停用 %s，此外掛已將其取代。"
L["msg:replacedInstalledFix"] = "刪除舊的安裝資料夾即可不再看到此訊息。"
...
L["msg:nothingToDo"] = "AzerothPrime：沒有需要移動的物品。"
L["msg:done"] = "AzerothPrime：完成。已移動 %d 件物品。"
L["msg:noVacancy"] = "AzerothPrime：戰隊銀行已滿。"
L["msg:blockedCombat"] = "AzerothPrime：已停止 — 你正在戰鬥中。"
L["msg:blockedBankClosed"] = "AzerothPrime：已停止 — 銀行已關閉。"
L["msg:blockedCursor"] = "AzerothPrime：已停止 — 游標上有物品。"
L["msg:blockedLocked"] = "AzerothPrime：已停止 — 物品已鎖定。"
L["msg:moveFailed"] = "AzerothPrime：已停止 — 移動未能完成。"
L["msg:openProfession"] = "AzerothPrime：請開啟一次%s視窗，讓 AzerothPrime 記錄你已學會的配方。"
...
L["msg:noVacancyPrivate"] = "AzerothPrime：你的銀行已滿。"
...
"在戰鬥中和副本裡，遊戲有時不會透露物品的詳細資訊。AzerothPrime 會保留這些物品，而不是去猜測，所以清單中可能會缺少個別物品 -- 這是正常現象。如果某個判定因為其他原因看起來有問題，值得回報。"
...
L["rule:junkSub"] = "預設關閉"
L["rule:junkBlurb"] =
"灰色物品，無論具體是哪種物品。預設關閉，因為這通常由其他外掛負責處理。如果沒有其他外掛處理，開啟這個選項，AzerothPrime 會替你清理它們。"
L["rule:epic"] = "傳說品質及以上"
L["rule:epicSub"] = "傳說、神器、傳家寶"
L["rule:epicBlurb"] =
"永不出售。商人會為這些物品顯示價格，隨後又拒絕這筆交易，因此 AzerothPrime 不會把它們列入清單。"
L["rule:reagent"] = "製作材料"
...
L["rule:bagsSub"] = "各種容器"
L["rule:bagsBlurb"] =
"永不出售。攜帶哪些背包由你自己決定，所以 AzerothPrime 不會對它們做判定。"
L["rule:gear"] = "武器與護甲"
...
L["rule:noneBlurb"] =
"AzerothPrime 完全不判定的物品類型：任務物品、鑰匙、籠中寵物、雕文、WoW 代幣、法術材料、箭矢，以及其他已停用的類別。無論上面的規則如何設定，它們都會留在你的背包裡。"
