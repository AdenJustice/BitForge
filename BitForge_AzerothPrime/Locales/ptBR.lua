...
L["msg:replacedInstalled"] = "AzerothPrime: %s desativado — substituído por este addon."
L["msg:replacedInstalledFix"] = "Exclua a pasta da instalação antiga para parar de ver esta mensagem."
...
L["msg:nothingToDo"] = "AzerothPrime: Nada para mover."
L["msg:done"] = "AzerothPrime: Concluído. %d item(ns) movido(s)."
L["msg:noVacancy"] = "AzerothPrime: O Banco do Bando de Guerra está cheio."
L["msg:blockedCombat"] = "AzerothPrime: Interrompido — você está em combate."
L["msg:blockedBankClosed"] = "AzerothPrime: Interrompido — o banco foi fechado."
L["msg:blockedCursor"] = "AzerothPrime: Interrompido — você está segurando algo no cursor."
L["msg:blockedLocked"] = "AzerothPrime: Interrompido — um item está bloqueado."
L["msg:moveFailed"] = "AzerothPrime: Interrompido — uma movimentação não foi concluída."
L["msg:openProfession"] = "AzerothPrime: Abra uma vez a janela de %s para que o AzerothPrime registre quais receitas você conhece."
...
L["msg:noVacancyPrivate"] = "AzerothPrime: Seu banco está cheio."
...
"Em combate e dentro de instâncias, o jogo às vezes não revela os detalhes de um item. O AzerothPrime mantém esses itens em vez de adivinhar, então alguns podem estar faltando na lista -- isso é esperado. Um veredito que pareça errado por qualquer outro motivo vale a pena reportar."
...
L["rule:junkBlurb"] =
"Itens cinzas, seja qual for o tipo. Desativado por padrão, porque geralmente outro addon já cuida disso. Se nenhum outro cuidar, ative esta opção e o AzerothPrime vai limpá-los para você."
L["rule:epic"] = "Lendário e acima"
L["rule:epicSub"] = "Lendário, Artefato, Herança"
L["rule:epicBlurb"] =
"Nunca é vendido. O vendedor mostra um preço para estes itens e depois recusa a venda, então o AzerothPrime não os coloca na lista."
...
L["rule:bagsBlurb"] =
"Nunca são vendidas. Quais mochilas você carrega é decisão sua, então o AzerothPrime não as avalia."
...
L["rule:noneBlurb"] =
"Tipos de item que o AzerothPrime não avalia de forma alguma: itens de missão, chaves, mascotes engaiolados, glifos, Símbolos da WoW, reagentes de feitiço, flechas e as outras categorias aposentadas. Eles ficam nas suas mochilas não importa como as regras acima estejam configuradas."
