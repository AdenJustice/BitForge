...
---@class BitForge.AzerothPrime.Model.AllowAudit
local allowAudit = {}
...
-- the real ladder instead: tests/test_azerothprime_allowaudit.lua runs a bag-less
...
---@class AzerothPrime.AllowAuditContext
...
---@param context AzerothPrime.AllowAuditContext
...
---@param context AzerothPrime.AllowAuditContext  required, and indexed directly
...
function allowAudit.UnreadBucket(cause)
    ...
    assert(bucket, "BitForge_AzerothPrime/model/allowAudit.lua: no bucket for the "
