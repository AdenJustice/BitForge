...
---@class BitForge.AzerothPrime.Model.OpenRules
local openRules = {}
...
---@class AzerothPrime.OpenRulesSuppress
...
---@param suppress AzerothPrime.OpenRulesSuppress|nil  which of this file's two
...
function openRules.Claim(facts, tooltipData, suppress)
    ...
    -- GatherByID, which /bfdump azerothprime and /bfdump azerothprime sell both
