...
--- link. tests/test_azerothprime_facts.lua drives every LAZY field against a
...
---@class BitForge.AzerothPrime.Model.Facts
local facts = {}
...
--- debug/dumps.lua's FindInBags, which /bfdump azerothprime open <id> uses to turn
