...
do
    ---@class BitForge.AzerothPrime.View.MerchantPanel
    local panel = {}
    ...
    local function BuildFrame()
        ...
        -- (BitForge/Libs/LibBitForgeUI/LibBitForgeUI.lua) is proof a host
        -- facade can read a frame's real geometry synchronously while
        -- painting it. Everything above this point builds content that needs
        -- nothing from MerchantFrame, but the skin pass is not content -- it
        -- has to see the panel at its real size, not CreateFrame's default 0x0.
