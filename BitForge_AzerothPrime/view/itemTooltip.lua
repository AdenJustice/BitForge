...
-- Every bag item tooltip gains the verdict AzerothPrime would give it and the rule
...
---@class BitForge.AzerothPrime.View.ItemTooltip
local itemTooltip = {}
do
    ...
    --- GetBagID as well, and a verdict on a slot AzerothPrime never considers would
