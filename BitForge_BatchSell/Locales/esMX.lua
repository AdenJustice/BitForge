...
"Permite la venta de armaduras y armas. Con esto desactivado, nunca se vende ningún equipo"
L["settings:ilvlThreshold"] = "Margen de nivel de objeto"
L["settings:ilvlThresholdTooltip"] =
"Cuántos niveles de objeto por debajo del objeto equipado en esa ranura puede estar una pieza y que aun así se conserve"
L["settings:marginOnHigherQuality"] = "  Aplicar margen a calidad superior"
L["settings:marginOnHigherQualityTooltip"] =
"Aplica el margen al equipo de calidad superior a la que tienes equipada. Con esto desactivado, cualquier mejora de calidad se conserva sin importar su nivel de objeto"
L["settings:marginOnSameQuality"] = "  Aplicar margen a la misma calidad"
L["settings:marginOnSameQualityTooltip"] =
"Aplica el margen al equipo de la misma calidad que el que tienes equipado. Con esto desactivado, solo se conserva el equipo igual o superior a tu nivel de objeto equipado"
L["settings:marginOnLowerQuality"] = "  Aplicar margen a calidad inferior"
L["settings:marginOnLowerQualityTooltip"] =
"Aplica el margen al equipo de calidad inferior a la que tienes equipada. Con esto desactivado, cualquier reducción de calidad se vende sin importar su nivel de objeto. El equipo con dos o más calidades por debajo nunca recibe el margen"
...
L["settings:keepUsedReagentsTooltip"] = "Conservar reactivos de artesanía que pueda usar cualquier profesión de esta cuenta"
...
"Conserva los materiales desde esta expansión en adelante y vende los más antiguos. Se usa solo cuando Materiales de fabricación está configurado para conservar desde una expansión elegida"
