...
L["settings:compareQuality"] = "比較品質"
L["settings:compareQualityTooltip"] = "出售品質低於已裝備物品的裝備，無論物品等級為何"
L["settings:compareItemLevel"] = "比較物品等級"
L["settings:compareItemLevelTooltip"] = "依物品等級比較裝備與已裝備物品，使用下方的邊際。關閉時物品等級不參與判斷"
L["settings:ilvlMargin"] = "物品等級邊際"
L["settings:ilvlMarginTooltip"] =
"一個品質等級折算多少物品等級。設為 10 時，比已裝備低一階的裝備需高出 10 才會保留，高一階的裝備低 10 以內也能保留。同品質則必須直接超過已裝備的。設為 0 時品質不再計入，僅依物品等級判斷"
L["settings:emphasizeQuality"] = "強調品質"
L["settings:emphasizeQualityTooltip"] =
"將一個品質等級按兩倍邊際計算，並允許同品質裝備低於該欄位一個邊際。高於已裝備的品質更容易保留，低於的則更難通融"
L["settings:keepForDisenchant"] = "保留可分解裝備"
L["settings:keepForDisenchantTooltip"] = "保留可以分解的裝備，供拍賣場出售或轉給擁有該專業的小號。附魔師無論此設定為何，都會保留自己已綁定的可分解裝備"
L["settings:spareBindOnAccount"] = "留存帳號綁定裝備"
L["settings:spareBindOnAccountTooltip"] = "決定保留哪些未綁定的帳號綁定裝備以傳給其他角色：本資料片的、全部、或不留存"
L["settings:spareBindOnEquip"] = "留存裝備後綁定裝備"
L["settings:spareBindOnEquipTooltip"] = "決定為其他角色或拍賣場保留哪些未綁定的裝備後綁定裝備：本資料片的、全部、或不留存"
...
L["settings:keepUncollectedCosmeticTooltip"] = "保留任何你尚未收藏其外觀的物品。一般裝備賣給商人仍會收藏外觀，但塑形物品要使用才會給出外觀——賣掉它，那個外觀就永遠沒了"
L["settings:sellRelics"] = "出售傳統聖物"
L["settings:sellRelicsTooltip"] = "出售神像、聖契、圖騰與魔印——浩劫與重生移除的那個聖物欄位。不是軍團再臨的神兵聖物，後者屬於寶石，只是子類編號相同而已"
...
L["settings:keepArtifactRelics"] = "保留神兵聖物"
L["settings:keepArtifactRelicsTooltip"] = "保留鑲嵌在軍團再臨神兵武器上的聖物。軍團再臨之後再無用處，除非你專門收藏，否則值得關掉"
...
L["settings:sellCollectedDecor"] = "出售已收藏的裝潢"
L["settings:sellCollectedDecorTooltip"] = "出售你的圖鑑中已有的住宅裝潢。圖鑑從未見過的裝潢會保留，讀不到圖鑑的那一件同樣保留"
...
L["reason:ENHANCEMENT_CURRENT"] = "該版本的物品強化被保留"
L["reason:ENHANCEMENT_LAST_EXPANSION"] = "上個版本的物品強化被保留"
L["reason:ENHANCEMENT_OUTDATED"] = "以前版本的物品強化被出售"
...
L["reason:TRADE_GOOD_SPARED"] = "你選擇保留的專業想要它"
...
L["rule:blackBlurb"] =
"永不出售清單中的物品會留在背包裡。當角色與戰團清單意見不一致時，以本角色的設定為準。"
L["rule:gates"] = "無法出售"
...
L["rule:cosmetic"] = "未收集的外觀"
L["rule:cosmeticSub"] = "你尚未收集的時裝物品"
L["rule:cosmeticBlurb"] =
"尚未收集的時裝物品會被保留。出售它並不會收集其外觀——外觀會直接消失——所以這是整個視窗中唯一一處犯錯無法挽回的地方。已經收集過的時裝物品不會僅僅因為它是時裝就被出售；它已經沒有需要保護的東西了，會繼續按照它本身是武器還是護甲來判定。"
...
L["rule:misc"] = "其他"
L["rule:miscSub"] = "寵物、坐騎、節日物品"
L["rule:miscBlurb"] =
"法術材料以及未分類的零碎物品不會被處理。灰色物品由上面的「低劣品質」規則處理，不在這裡。"
...
L["rule:housingBlurb"] =
"一旦某件裝飾品被收集，物品本身就沒有進一步用途了，因此可以賣給商人。染料完全不是這類東西：它是一次性消耗品，使用後就用完了，所以既沒有可收集的內容，也沒有可學習的內容。它也從不綁定，所以唯一值得問的問題是它是否還能送到想要它的人手上。"
L["rule:none"] = "其餘全部"
