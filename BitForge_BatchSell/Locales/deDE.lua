...
L["settings:keepForDisenchant"] = "Entzauberwürdige Ausrüstung behalten"
L["settings:keepForDisenchantTooltip"] =
"Behaltet Ausrüstung, die ein Verzauberer entzaubern könnte, danach, was sie einbringen würde. Ausrüstung aus einer abgeschlossenen Erweiterung liefert die Materialien dieser Erweiterung, weshalb es hier um die Materialien geht und nicht um die Ausrüstung. Euer eigener Verzauberer behält immer, was nur er erreichen kann, bei jeder Einstellung -- diese Einstellung entscheidet aber weiterhin, ob das auch ältere Materialien einschließt"
L["settings:spareBindOnAccount"] = "Kontogebundene Ausrüstung schonen"
L["settings:spareBindOnAccountTooltip"] =
"Welche kontogebundene Ausrüstung behalten wird, solange sie noch an einen anderen Charakter weitergegeben werden kann: die dieser Erweiterung, alle oder keine"
L["settings:spareBindOnEquip"] = "Beim Anlegen gebundene Ausrüstung schonen"
L["settings:spareBindOnEquipTooltip"] =
"Welche beim Anlegen bindende Ausrüstung behalten wird, solange sie noch einen anderen Charakter oder das Auktionshaus erreichen kann: die dieser Erweiterung, alle oder keine"
...
L["materials:current"] = "Aktuelle Materialien"
L["materials:all"] = "Alle Materialien"
L["materials:none"] = "Nicht behalten"
...
L["option:lastExpansion"] = "Und aus der letzten, solange Ihr dort noch levelt"
...
L["reason:ENHANCEMENT_CURRENT"] = "Gegenstandsverbesserungen für diese Erweiterung werden behalten"
L["reason:ENHANCEMENT_LAST_EXPANSION"] = "Gegenstandsverbesserungen der letzten Erweiterung werden behalten"
L["reason:ENHANCEMENT_OUTDATED"] = "Gegenstandsverbesserungen für frühere Erweiterungen werden verkauft"
...
L["rule:junkBlurb"] =
"Graue Gegenstände, unabhängig davon, um welche Art von Gegenstand es sich handelt. Standardmäßig aus, weil das meist schon ein anderes Addon übernimmt. Wenn nichts anderes es tut, schaltet es ein, und BatchSell räumt sie für Euch weg."
...
"Legt für jede Art von Verbrauchsgegenstand fest, was behalten wird. Alles, was kein Kästchen behält, wird verkauft. Tränke, Elixiere, Fläschchen sowie Essen & Trinken erhalten noch eine weitere Option -- auch die der letzten Erweiterung --, die nur gilt, solange Ihr die dieser Erweiterung behaltet."
L["rule:bags"] = "Taschen"
L["rule:bagsSub"] = "Behälter jeder Art"
L["rule:bagsBlurb"] =
"Werden nie verkauft. Welche Taschen Ihr tragt, ist Eure Entscheidung, deshalb beurteilt BatchSell sie nicht."
...
"Eine neue Erweiterung begrenzt die Ausrüstung, auf die diese angewendet werden können, sodass ältere ihren Wert verlieren. Die dieser Erweiterung werden behalten, und die der letzten Erweiterung ebenfalls, wenn Ihr das möchtet."
...
L["rule:noneBlurb"] =
"Gegenstandsarten, die BatchSell überhaupt nicht beurteilt: Questgegenstände, Schlüssel, eingesperrte Haustiere, Glyphen, WoW-Marken, Zauberreagenzien, Pfeile und die anderen ausrangierten Kategorien. Sie bleiben in Euren Taschen, egal wie die Regeln oben eingestellt sind."

-- The report window's footnote. What BatchSell discloses is not what Openables
-- discloses, so each module states its own.
L["report:blurb"] = "Dieser Bericht enthält den Link des Gegenstands, das, was Ihr in dem Platz tragt, den er einnehmen würde, und die Einstellungen, die das Paar beurteilt haben. Ein Gegenstandslink verrät die Stufe und Spezialisierung Eures Charakters -- das ist Teil des Formats des Links selbst, und ihn zu entfernen würde die Details verlieren, die den Bericht nachvollziehbar machen. Nichts hier nennt Euren Charakter, Euren Realm, Eure Gilde oder Eure Fraktion, und nichts beschreibt einen anderen Platz."
...
L["report:blurbDisenchant"] = "Dieser Bericht enthält bis zu acht Waffen oder Rüstungsteile aus Euren Taschen, die sich zum Entzaubern lohnen könnten, zusammen mit dem jeweiligen Platz in der Tasche und dem vollständigen Text seines Tooltips. Nichts hier nennt Euren Charakter, Euren Realm, Eure Gilde oder Eure Fraktion, und nichts sonst in Euren Taschen wird beschrieben."
