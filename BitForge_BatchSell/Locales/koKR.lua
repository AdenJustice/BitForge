...
L["settings:sellJunkTip"]                     = "낮은 품질(회색) 아이템을 상인 방문 시 자동으로 판매합니다"
L["settings:keepEquippable"]                  = "착용 가능 아이템 유지"
L["settings:keepEquippableTip"]               = "내 직업이 착용 가능한 모든 아이템을 유지합니다"
L["settings:keepBindOnAccount"]               = "전투부대 귀속 아이템 유지"
L["settings:keepBindOnAccountTip"]            = "전투부대 귀속(가보) 장비를 유지합니다"
L["settings:keepBindOnAccountPastExpac"]      = "  이전 확장팩 포함"
L["settings:keepBindOnAccountPastExpacTip"]   = "이전 확장팩의 전투부대 귀속 장비도 유지합니다"
L["settings:keepDisenchantables"]             = "마력 추출 가능 아이템 유지"
L["settings:keepDisenchantablesTip"]          = "마법부여사: BOP/BOE/BOA 장비 유지. 그 외: 경매장/분신용 BOE/BOA 장비 유지"
L["settings:keepDisenchantablesPastExpac"]    = "  이전 확장팩 포함"
L["settings:keepDisenchantablesPastExpacTip"] = "이전 확장팩의 마력 추출 가능 장비도 유지합니다"
L["settings:limitBatch"]                      = "12개씩 판매"
L["settings:limitBatchTip"]                   = "서버 제한 방지를 위해 한 번에 최대 12개까지만 판매합니다"
L["settings:qualityThreshold"]                = "품질 기준"
L["settings:qualityThresholdTip"]             = "이 품질 이하의 아이템을 판매합니다"
L["settings:ilvlThreshold"]                   = "아이템 레벨 여유"
L["settings:ilvlThresholdTip"]                = "장착 중인 장비보다 이 수치 내의 아이템은 유지합니다 (음수 = 더 좋은 아이템 유지)"
L["settings:sellPastExpansion"]               = "이전 확장팩 아이템 판매"
L["settings:sellPastExpansionTip"]            = "선택한 기준보다 오래된 확장팩 아이템을 판매합니다"
L["settings:expansionThreshold"]              = "확장팩 기준"
L["settings:expansionThresholdTip"]           = "선택한 확장팩보다 오래된 아이템을 판매합니다"
