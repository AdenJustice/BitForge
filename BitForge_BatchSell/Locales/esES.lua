...
"En combate y dentro de instancias, el juego a veces no revela los detalles de un objeto. BatchSell conserva esos objetos en lugar de suponer, así que puede que falten algunos en la lista -- eso es normal. Un veredicto que parezca incorrecto por cualquier otro motivo merece la pena reportarlo."
...
"Conservar reagentes de artesanía que pueda usar una profesión de esta cuenta. Un objeto vinculado al alma nunca llega a otro personaje, así que solo lo conservan las profesiones de este personaje"
L["settings:compareQuality"] = "Comparar calidad"
L["settings:compareQualityTooltip"] =
"Vender el equipo cuya calidad sea inferior a la que llevas, sin importar el nivel de objeto"
L["settings:compareItemLevel"] = "Comparar nivel de objeto"
L["settings:compareItemLevelTooltip"] =
"Comparar el equipo con el que llevas por nivel de objeto, usando el margen de abajo. Con esto desactivado, el nivel de objeto no influye en la decisión"
...
L["settings:keepForDisenchant"] = "Conservar equipo desencantable"
L["settings:keepForDisenchantTooltip"] =
"Conservar el equipo que se pudiera desencantar, para la casa de subastas o un alt con la profesión. Los encantadores siempre conservan su propio equipo vinculado desencantable, sin importar este ajuste"
L["settings:spareBindOnAccount"] = "Perdonar equipo vinculado a cuenta"
L["settings:spareBindOnAccountTooltip"] =
"Qué equipo sin vincular vinculado a cuenta conservar para que una copia llegue a otro personaje: el de esta expansión, todo, o ninguno"
L["settings:spareBindOnEquip"] = "Perdonar equipo vinculado al equipar"
L["settings:spareBindOnEquipTooltip"] =
"Qué equipo sin vincular que se vincula al equiparlo conservar para otro personaje o la casa de subastas: el de esta expansión, todo, o ninguno"
L["settings:reagentsCurrentOnly"] = "Solo componentes de esta expansión"
L["settings:reagentsCurrentOnlyTooltip"] =
"Restringe la regla anterior a los componentes de la expansión actual. Una receta que pide una hierba de Classic la sigue pidiendo igual hoy, así que esto queda desactivado salvo que prefieras no acumular componentes antiguos"
...
"Conserva las gemas de la expansión actual. Las más antiguas pasan a las dos preguntas de abajo"
L["settings:gemsRecipesNow"] = "Conservar gemas actuales que pida una receta"
L["settings:gemsRecipesNowTooltip"] =
"Conserva una gema de la expansión actual que alguna receta de profesión use como componente, sea de quien sea esa profesión. La pregunta va al catálogo de recetas, y una gema que nunca ha visto se conserva en vez de adivinarse"
...
"Conserva las mejoras de objeto de la expansión inmediatamente anterior, para un personaje que todavía lleva ese equipo. Solo se ofrece esa: nadie sube niveles por la anterior a ella"
...
"Conserva una receta todavía sin vincular, para que llegue a un alt o a la casa de subastas aunque este personaje ya la haya aprendido"
...
"Conserva un material de comercio si alguna profesión marcada aquí podría usarlo como reagente -- para un personaje secundario que aún no la haya aprendido, o para la casa de subastas. Las profesiones de esta cuenta ya están cubiertas por Conservar reagentes de tus profesiones"
...
L["option:lastExpansion"] = "Y de la anterior, mientras subes de nivel en ella"
L["option:recipesNow"] = "Conservar los de esta expansión salvo que ninguna receta los quiera"
L["option:recipesOld"] = "Conservar los más antiguos salvo que ninguna receta los quiera"
...
L["reason:PROFESSION_GEAR_KEPT"] = "El equipo profesional nunca se vende"
L["reason:ENHANCEMENT_CURRENT"] = "Se mantienen los encantamientos de esta expansión"
L["reason:ENHANCEMENT_LAST_EXPANSION"] = "Se mantienen los encantamientos de la expansión anterior"
L["reason:ENHANCEMENT_OUTDATED"] = "Se venden los encantamientos de expansiones anteriores"
...
L["reason:CONSUMABLE_REAGENT"] = "Alguna receta usa esto como reactivo"
L["reason:GEM_CURRENT"] = "Las gemas de esta expansión se conservan"
L["reason:GEM_REAGENT"] = "Alguna receta usa esto como reactivo"
L["reason:GEM_ARTIFACT_RELIC_KEPT"] = "Las reliquias de artefacto se conservan"
L["reason:TRADE_GOOD_SPARED"] = "Una profesión que decidiste conservar quiere esto"
...
L["rule:blackBlurb"] =
"Todo lo que esté en tu lista de nunca vender se queda en tus bolsas. Un ajuste de este personaje prevalece sobre la lista del Grupo de Guerra, sea cual sea el sentido en que discrepen."
...
L["rule:whiteBlurb"] =
"Todo lo que esté en tu lista de vender siempre se vende, incluso cuando una regla posterior lo habría conservado. Así es como vendes ese reagente de artesanía concreto que no quieres."
...
L["rule:reagent"] = "Reagentes de artesanía"
L["rule:reagentSub"] = "Usa tu lista de profesiones"
L["rule:reagentBlurb"] =
"Conserva cualquier reagente que pueda usar una profesión de esta cuenta, sea cual sea el tipo de objeto. Los reagentes aparecen tanto en pociones como en gemas y materiales de comercio, así que esto se comprueba antes que el tipo de objeto. La lista se lee de las propias recetas del juego, así que ya incluye los reagentes opcionales que admite una receta y todos sus niveles de calidad -- no tienes que abrir ni escanear nada."
...
"Elige qué conservar de cada tipo de consumible. Todo lo que ninguna casilla conserve se vende. Las pociones, elixires, filtros y la comida reciben una opción más -- también los de la expansión anterior --, que solo se aplica mientras conservas los de esta expansión."
L["rule:bags"] = "Bolsas"
L["rule:bagsSub"] = "Contenedores de todo tipo"
L["rule:bagsBlurb"] =
"Nunca se venden. Qué bolsas llevas es decisión tuya, así que BatchSell no las juzga."
...
"Elige de quién conservar los reagentes. Todo lo que no perdones se vende -- aunque un reagente que tus propias profesiones usen de verdad ya lo conserva la regla Reagentes de artesanía de arriba."
L["rule:enhancements"] = "Mejoras de objeto"
L["rule:enhancementsSub"] = "Encantamientos, aceites, piedras"
L["rule:enhancementsBlurb"] =
"Una nueva expansión limita el equipo al que se pueden aplicar, así que las antiguas dejan de valer nada. Las de esta expansión se conservan, y las de la expansión anterior también, si quieres."
...
L["rule:misc"] = "Varios"
L["rule:miscSub"] = "Mascotas, monturas, objetos de festividad"
L["rule:miscBlurb"] =
"Los reagentes de hechizos y las cosas sin categorizar se dejan intactas. Los objetos grises los gestiona la regla Calidad pobre de arriba, no esta."
...
L["rule:noneBlurb"] =
"Tipos de objeto que BatchSell no juzga en absoluto: objetos de misión, llaves, mascotas enjauladas, glifos, vales de WoW, reagentes de hechizos, flechas y las demás categorías retiradas. Se quedan en tus bolsas sin importar cómo estén configuradas las reglas de arriba."

-- The report window's footnote. What BatchSell discloses is not what Openables
-- discloses, so each module states its own.
L["report:blurb"] = "Este informe incluye el vínculo del objeto, lo que lleves puesto en la ranura que ocuparía, y los ajustes que juzgaron el par. Un vínculo de objeto indica el nivel y la especialización de tu personaje -- eso forma parte del propio formato del vínculo, y eliminarlo perdería el detalle que hace reproducible el informe. Nada aquí nombra a tu personaje, tu reino, tu hermandad o tu facción, y nada describe ninguna otra ranura."
