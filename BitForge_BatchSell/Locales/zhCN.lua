...
L["settings:compareQuality"] = "比较品质"
L["settings:compareQualityTooltip"] = "出售品质低于已装备物品的装备，无论物品等级如何"
L["settings:compareItemLevel"] = "比较物品等级"
L["settings:compareItemLevelTooltip"] = "按物品等级比较装备与已装备物品，使用下方的余量。关闭后物品等级不参与判断"
...
L["settings:keepForDisenchant"] = "保留可分解装备"
L["settings:keepForDisenchantTooltip"] = "保留可以分解的装备，供拍卖行出售或转给有该专业的小号。附魔师无论此设置如何都会保留自己已绑定的可分解装备"
L["settings:spareBindOnAccount"] = "留存绑定账号装备"
L["settings:spareBindOnAccountTooltip"] = "决定保留哪些未绑定的绑定账号装备以传给其他角色：本资料片的、全部、或不留存"
L["settings:spareBindOnEquip"] = "留存装备后绑定装备"
L["settings:spareBindOnEquipTooltip"] = "决定为其他角色或拍卖行保留哪些未绑定的装备后绑定装备：本资料片的、全部、或不留存"
...
L["settings:keepUncollectedCosmeticTooltip"] = "保留任何你尚未收藏其外观的物品。普通装备卖给商人仍会收藏外观，但塑形物品要使用才会给出外观——卖掉它，那个外观就永远没了"
L["settings:sellRelics"] = "出售经典圣物"
L["settings:sellRelicsTooltip"] = "出售神像、圣契、图腾与魔印——大地的裂变移除的那个圣物栏位。不是军团再临的神器圣物，后者属于宝石，只是子类编号相同而已"
...
L["settings:keepArtifactRelics"] = "保留神器圣物"
L["settings:keepArtifactRelicsTooltip"] = "保留镶嵌在军团再临神器武器上的圣物。军团再临之后再无用处，除非你专门收藏，否则值得关掉"
...
L["settings:sellCollectedDecor"] = "出售已收藏的装潢"
L["settings:sellCollectedDecorTooltip"] = "出售你的图鉴中已有的住宅装潢。图鉴从未见过的装潢会保留，读不到图鉴的那一件同样保留"
...
L["reason:ENHANCEMENT_CURRENT"] = "该版本的物品强化被保留"
L["reason:ENHANCEMENT_LAST_EXPANSION"] = "上个版本的物品强化被保留"
L["reason:ENHANCEMENT_OUTDATED"] = "以前版本的物品强化被出售"
...
L["reason:TRADE_GOOD_SPARED"] = "你选择保留的专业想要它"
...
L["reason:OUTDATED_EXPAC"] = "优于你当前装备的上个版本物品"
...
L["reason:ALREADY_COLLECTED"] = "已经收集，因此予以出售"
...
L["rule:cosmetic"] = "未收集的外观"
L["rule:cosmeticSub"] = "你尚未收集的时装物品"
L["rule:cosmeticBlurb"] =
"尚未收集的时装物品会被保留。出售它并不会收集其外观——外观会直接消失——所以这是整个窗口中唯一一处犯错无法挽回的地方。已经收集过的时装物品不会仅仅因为它是时装就被出售；它已经没有需要保护的东西了，会继续按照它本身是武器还是护甲来判定。"
...
L["rule:misc"] = "其他"
L["rule:miscSub"] = "宠物、坐骑、节日物品"
L["rule:miscBlurb"] =
"法术材料以及未分类的零碎物品不会被处理。灰色物品由上面的“低劣品质”规则处理，不在这里。"
...
L["rule:housingBlurb"] =
"一旦某件装饰品被收集，物品本身就没有进一步用途了，因此可以卖给商人。染料完全不是这类东西：它是一次性消耗品，使用后就用完了，所以既没有可收集的内容，也没有可学习的内容。它也从不绑定，所以唯一值得问的问题是它是否还能送到想要它的人手上。"
L["rule:none"] = "其余全部"
