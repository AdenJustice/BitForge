...
L["settings:collectorCharacterTooltip"] = "전투부대 은행에서 잉여 금화를 수금할 캐릭터"

L["settings:none"] = "없음"
L["settings:always"] = "항상"

L["msg:deposit"] = "전투부대 은행에 %s 입금했습니다"
L["msg:withdraw"] = "전투부대 은행에서 %s 출금했습니다"
L["msg:collect"] = "전투부대 은행에서 %s 수금했습니다"
L["msg:noFunds"] = "전투부대 은행에 출금할 금액이 없습니다"
